...
export default function Home() {
  ...
  return (
    <main className={`flex flex-col gap-5 h-screen items-center bg-black !font-sans ${inter.className}`} >
      <div className=' w-[40%] mt-12 rounded-xl py-8 border border-cyan-400 px-8'>
      ...
      {userData && (
        <div className='w-[50%] px-8 py-4 mt-8'>
          <Tabs value="profile">
            ...
            <TabsBody className='border '>
              {data.map(({ value, desc }) => (
                <TabPanel key={value} value={value} className="py-0 px-5 mt-5 h-48">
                  {
                    value == "profile" ? (
                      <div>
